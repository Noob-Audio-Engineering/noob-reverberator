...
// Vite configuration for the Noob Reverberator SPA.
//
...
//
//     cargo run --bin noob-reverberator-standalone      # terminal 1
//     NOOB_VST_WEBGUI_FRAMEWORK_PORT=4242 npm run dev                     # terminal 2, in web/
const serverPort = process.env.NOOB_VST_WEBGUI_FRAMEWORK_PORT || '4251';
